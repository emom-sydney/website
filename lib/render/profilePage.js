import { getImageThumbnailResult } from "../../src/_data/imageHelpers.js";
...
export async function renderProfileIntro(profilePage, options = {}) {
  ...
  if (image && image.imageURL) {
    ...
    const thumbnail = await getImageThumbnailResult(image.imageURL, profile.stageName);
    thmUrl = thumbnail.ok ? thumbnail.url : missingImageThumbnailUrl;
  }
